        ...
        cboMetodoPago.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                }else if (parent.getItemAtPosition(position).toString().equals("Efectivo"))
                {
                    ...
                    textView21.setVisibility(view.GONE);
                    tvMensajePago.setText("Nota: El pago en efectivo se realizará al momento de apersonarse a la bodega");
    ...
    public void onClick(View v) {
        ...
        switch (v.getId())
        {
            case R.id.btnRealizarPagoFin:{
                ...
                {
                    if (!banco.equals("Seleccione:"))
                    {
                        if (!etTransferencia.getText().toString().equals(""))
                        {
                        ...
                        {
                            Toast.makeText(this,"Ingrese el número de operación",Toast.LENGTH_SHORT).show();
                        }
                    }else
                    {
                        Toast.makeText(this,"Seleccione el banco para la transferencia",Toast.LENGTH_SHORT).show();
                    }

                }else if(!metodoPago.equals("Seleccione:") && metodoPago.equals("Efectivo"))
                {
                    banco ="";
                    SharedPreferences preferences1 = getSharedPreferences("appBodega",MODE_PRIVATE);
                    System.out.println("ID Usuario: "+preferences1.getString("id",""));
                ...
                {
                    Toast.makeText(this,"Favor de elegir un Método de Pago",Toast.LENGTH_SHORT).show();
                }
            }break;
        }
    }
